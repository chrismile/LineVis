...
/*
 * Changes by Christoph Neuhauser:
 * - Changed uint16_t to uint32_t for ForsythVertexIndexType.
 * - Changed C-style header includes (e.g., stdint.h) to C++-style header includes (e.g., cstdint).
 */
